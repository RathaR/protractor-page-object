...
//                context: element(by.css('body'))
//            };
//            var list = new Core.BaseElementList(listRootLocator, Core.BaseElement, by.css('[ng-repeat="module in modules"]'), null);
//            expect(list.isDisplayed()).toBeTruthy();
//            expect(list.all().count()).toEqual(4);
//            expect(list.get(0).isDisplayed()).toBeTruthy();
//        });
//
//        it('should create list of lists ', () => {
//            var listRootLocator = {
//                locator: by.css('[ng-controller="DocsController"]'),
//                context: element(by.css('body'))
//            };
